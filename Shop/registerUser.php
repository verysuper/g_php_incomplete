...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="registerUser.php?msguser=您的帳號已使用";
...
sendmail($_POST['userid'],$_POST['mail']);
  $insertGoTo = "index.php?msg=會員註冊成功，記得收信驗證";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" id="form1" name="form1">
      <table width="100%">
        <tr>
          ...
          <td><input type="text" name="userid" value="" size="32" /><h5><? echo $_GET['msguser']; ?></h5></td>
        </tr>
        <tr>
        ...
        <tr>          
          ...
          <input type="submit" value="註冊會員"/></td>
        </tr>
      </table>
...
function passwordCheck(){
	...
	if(form1.password.value!=form1.password2.value){
		...
		msg.innerHTML="<font color=green>密碼與確認密碼相符！</font>";
	}
}
</script>
<?php
